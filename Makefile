...
# Template: app
# Command: D:\Qt\Qt5.5.0\5.5\mingw492_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" -o Makefile KImageMerge.pro
#############################################################################
...
Makefile: KImageMerge.pro ../../Qt5.5.0/5.5/mingw492_32/mkspecs/win32-g++/qmake.conf ../../Qt5.5.0/5.5/mingw492_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ "CONFIG+=debug" -o Makefile KImageMerge.pro
