#ifndef QMASKDODADJUST_H
#define QMASKDODADJUST_H
...
class QMaskDodAdjust : public MainWindow
{
    Q_OBJECT
public:
    QMaskDodAdjust(QWidget* parent= 0, QString _title = QObject::tr("背景剪去矫正算法"))
        : MainWindow(parent)
        , m_bright(32768)
        , m_scaleParam(1070.f)
        , m_sigma(.36)
